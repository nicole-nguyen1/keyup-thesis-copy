      ...
      <CardContent>
        ...
        <div className={classes.grid}>
          <div className={classes.cell}>
            <img src='https://s3.amazonaws.com/keyup-assets/lightbulb-white.png' className={classes.image} />
          ...
          <div className={classes.cell}>
            <img src='https://s3.amazonaws.com/keyup-assets/Zero-In-(target).png' className={classes.image} />
          ...
          <div className={classes.cell}>
            <img src='https://s3.amazonaws.com/keyup-assets/Connect-(handshake)-icon.png' className={classes.image} />
          ...
          <div className={classes.cell}>
            <img src='https://s3.amazonaws.com/keyup-assets/Go-(rocket-ship)-icon.png' className={classes.image} />
